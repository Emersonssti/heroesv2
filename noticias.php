...
<article class="post has-post-thumbnail ">
	...
	<div class="post__body">
		<div class="post__header">
			...
			<h2 class="post__title h4"><a href="blog-post.html"><?= $result[1]; ?></a></h2>
	...
	$sql = "SELECT
	  ...
	  ?>
						<li class="ncr-posts-list__item has-post-thumbnail post">
							<div class="post__thumbnail">
								<a href="blog-post.html"><img src="<?= $result[6]; ?>" alt=""></a>
							</div>
							<div class="post__body">
								<div class="post__header">
									<ul class="post__cats list-unstyled">
									...
									<h2 class="post__title h6"><a href="blog-post.html"><?= $result[1]; ?></a></h2>
									<ul class="post__meta list-unstyled">
										<li class="post__meta-item post__meta-item--date">
										<?= $data; ?>
										</li>
			...
			<li class="ncr-posts-list__item has-post-thumbnail post">
				...
				<div class="post__body">
					<div class="post__header">
						...
						<h2 class="post__title h6"><a href="blog-post.html" class="stretched-link"> &nbsp;</a></h2>
						<ul class="post__meta list-unstyled">
